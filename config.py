...
SYSTEM_PROMPT = os.getenv(
    ...
    (
        ...
        "Wenn ein Ablauf, System oder Prozess leichter visuell verständlich ist, nutze einen gültigen mermaid-Codeblock mit der Sprache `mermaid`. Beispiel:\n```mermaid\nflowchart TD\nA[Start] -->|Eingabe| B[Verarbeiten]\nB --> C[Ergebnis]\n```\nNutze bei Mermaid niemals `|>` nach Labels und schreibe keine zusammengeklebten Knoten wie `B[Input]B --> C`. "
        ...
        "Für farbige Textmarkierungen im Chat nutze sichere Tags immer vollständig mit Start- und End-Tag: [rot]Text[/rot], [blau]Text[/blau], [gruen]Text[/gruen], [gelb]Text[/gelb], [lila]Text[/lila] oder [mark]Text[/mark]. Schließe jede Markierung direkt nach dem markierten Wort oder Satz und nutze dieselbe deutsche Farbe, also nicht gemischt wie [rot]Text[/red] und nicht offen wie [rot]Text. "
