...
LEON AI is released under the **MIT License**. The copyright notice with **Leon** as the author must remain in the code and license files.
...
LEON AI steht unter der **MIT-Lizenz**. Der Copyright-Hinweis mit **Leon** als Urheber muss im Code und in den Lizenzdateien erhalten bleiben.
